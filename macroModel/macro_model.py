...
#Defining Initials
initials = {"Price_debt_token":[1.00], "Price_Ether":[price_ether_initial], "n_open":[initial_open], "n_close":[0], "n_liquidate": [0], "n_redempt":[0], 
...
#Summary
  ...
  new_row = {"Price_debt_token":float(price_debt_token_current), "Price_Ether":float(price_ether_current), "n_open":float(n_open), "n_close":float(n_close), 
...
fig.update_layout(
    title_text="Price Dynamics of Debt Token and Ether"
)
