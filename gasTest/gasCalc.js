...
contract('Gas cost tests', async accounts => {
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues 100 token'

  //   const amountETH = dec(10, 'ether')
  //   const amountDebtToken = 0
  //   const gasResults = await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountDebtToken)
  ...
  // it("", async () => {
  //   const message = 'openTrove(), 10 accounts, each account adds 10 ether and issues less token than the previous one'
  //   const amountETH = dec(10, 'ether')
  //   const amountDebtToken = 200
  //   const gasResults = await th.openTrove_allAccounts_decreasingDebtTokenAmounts(_10_Accounts, contracts, amountETH, amountDebtToken)
  //   th.logGasMetrics(gasResults, message)
  //   th.logAllGasCosts(gasResults)
  ...
  it("", async () => {
    const message = 'openTrove(), 50 accounts, each account adds random ether and random token'
    const amountETH = dec(10, 'ether')
    const amountDebtToken = 0
    const gasResults = await th.openTrove_allAccounts_randomETH_randomDebtToken(1, 9, _50_Accounts, contracts, 2, 100, true)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/token Increase/Increase. 10 accounts, each account adjusts up -  1 ether and 100 token'
  ...
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, amountETH, amountDebtToken)


  //   const amountETH_2 = dec(1, 'ether')
  //   const amountDebtToken_2 = dec(100, 18)
  //   const gasResults = await th.adjustTrove_allAccounts(_10_Accounts, contracts, amountETH_2, amountDebtToken_2)
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/token Decrease/Decrease. 10 accounts, each account adjusts down by 0.1 ether and 10 token'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  // it("", async () => {
  //   const message = 'adjustTrove(). ETH/token Increase/Decrease. 10 accounts, each account adjusts up by 0.1 ether and down by 10 token'
  //   await borrowerOperations.openTrove(_100pct, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  //   const amountETH = dec(10, 'ether')
  //   const amountDebtToken = dec(100, 18)
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, amountETH, amountDebtToken)

  //   // Randomly add between 1-9 ETH, and withdraw 1-100 token
  ...
  it("", async () => {
    ...
    const amountDebtToken = dec(100, 18)
    await th.openTrove_allAccounts(_40_Accounts, contracts, amountETH, amountDebtToken)
    // Randomly add between 1-9 ETH, and withdraw 1-100 token
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts_decreasingDebtTokenAmounts(_10_Accounts, contracts, dec(10, 'ether'), 200)
  ...
  it("", async () => {
    const message = 'closeTrove(), 20 accounts, each account adds 10 ether and issues less debt token than the previous one. First 10 accounts close their trove. '

    await th.openTrove_allAccounts_decreasingDebtTokenAmounts(_20_Accounts, contracts, dec(10, 'ether'), 200)
  ...
  // it("", async () => {
  //   const message = 'withdrawDebtToken(), first withdrawal, 10 accounts, each account withdraws 100 token'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  // it("", async () => {
  //   const message = 'withdrawDebtToken(), second withdrawal, 10 accounts, each account withdraws 100 token'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  it("", async () => {
    const message = 'withdrawDebtToken(), first withdrawal, 30 accounts, each account withdraws a random debt token amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  it("", async () => {
    const message = 'withdrawDebtToken(), second withdrawal, 30 accounts, each account withdraws a random debt token amount'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  // it("", async () => {
  //   const message = 'repayDebtToken(), partial repayment, 10 accounts, repay 30 token (of 100 token)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  // it("", async () => {
  //   const message = 'repayDebtToken(), second partial repayment, 10 accounts, repay 30 token (of 70 token)'
  //   await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'repayDebtToken(), partial repayment, 30 accounts, repay random amount of token (of 100 token)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18))

    const gasResults = await th.repayDebtToken_allAccounts_randomAmount(1, 99, _30_Accounts, contracts)
    th.logGasMetrics(gasResults, message)
    th.logAllGasCosts(gasResults)
  ...
  // it("", async () => {
  //   const message = 'repayDebtToken(), first repayment, 10 accounts, repay in full (100 of 100 token)'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'repayDebtToken(), first repayment, 30 accounts, repay in full (50 of 50 token)'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, randDebtTokenAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  it("", async () => {
    ...
    const randDebtTokenAmount = th.randAmountInWei(1, 180)
    await borrowerOperations.openTrove(_100pct, randDebtTokenAmount, accounts[1], ZERO_ADDRESS, { from: accounts[1], value: dec(10, 'ether') })
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and 100 token withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  it("", async () => {
    const message = 'getCurrentICR(), Troves with 10 ether and random debt token amount withdrawn, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(100, 18))
  ...
  // --- redeemCollateral() ---
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 token, redemption hits 1 Trove. One account in system, partial redemption'
    await th.openTrove_allAccounts([accounts[0]], contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts([accounts[0]], contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 token, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less token
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })

    /* Account 2 redeems 50 token. It is redeemed from account 0's Trove, 
    leaving the Trove active with 30 token and ((200 *10 - 50 ) / 200 ) = 9.75 ETH. 
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 101 token, redemption hits 2 Troves, last redemption is partial'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 token, redemption hits 5 Troves, all full redemptions'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 450 token, redemption hits 5 Troves,  last redemption is partial (50 of 100 token)'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))

    // Whale adds 200 ether, withdraws 450 token, redeems 500 token
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(450, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(1000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(1500, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(_100pct, 0, whale, ZERO_ADDRESS, { from: whale, value: dec(200, 'ether') })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(2000, 18), whale, ZERO_ADDRESS, { from: whale })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 token, redemption hits 1 Trove, WITH pending rewards. One account in system'
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, 'ether'), 0)
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })

    // acct 998 adds coll, withdraws token, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, { from: accounts[998] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeems 50 token, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.'
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, 'ether'), 0)
    // 3 accounts withdraw successively less token
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0] })
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 500 token, WITH pending rewards, redemption hits 5 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1000 token, WITH pending rewards, redemption hits 10 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 1500 token, WITH pending rewards, redemption hits 15 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_20_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_20_Accounts, contracts, dec(100, 18))
  ...
  it("", async () => {
    const message = 'redeemCollateral(), redeemed 2000 token, WITH pending rewards, redemption hits 20 Troves, WITH pending rewards'
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18))
  ...
  //    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[999], ZERO_ADDRESS, { from: accounts[999]})
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, part of issued token: all accounts withdraw 180 token, all make first deposit, provide 100 token'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, all issued token: all accounts withdraw 180 token, all make first deposit, 180 token'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 token, all make first deposit, random debt token amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, deposit part of issued token: all accounts withdraw 180 token, all make second deposit, provide 50 token'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), No pending rewards, deposit all issued token: all accounts withdraw 180 token, make second deposit, provide 90 token'
  //   await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
  //   await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18))
  //   await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  it("", async () => {
    const message = 'provideToSP(), No pending rewards, all accounts withdraw 180 token, make second deposit, random debt token amount'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), 0)
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit part of issued token: all accounts make second deposit, provide 50 token'
  ...
  //   await th.withdrawDebtToken_allAccounts(accounts.slice(2, 12), contracts, dec(130, 18))
  ...
  // it("", async () => {
  //   const message = 'provideToSP(), with pending rewards in system. deposit all issued token: all accounts make second deposit, provide 90 token'
  ...
  it("", async () => {
    const message = 'provideToSP(), with pending rewards in system. deposit part of issued token: all make second deposit, provide random debt token amount'
    // 10 accts each open Trove with 10 ether, withdraw 180 token, and provide 90 token to Stability Pool
  ...
  // full
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make full withdrawal - 130 token of 130 token deposit'
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, 'ether'), dec(190, 18))
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(130, 18))
  ...
  // random amount
  it("", async () => {
    const message = 'withdrawFromSP(), no pending rewards. Stability Pool depositors make partial withdrawal - random debt token amount, less than 180 token deposit'
  ...
  //   await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, { from: accounts[1] })
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make full withdrawal - 130 token of 130 token deposit'
    // 10 accts each open Trove with 10 ether, withdraw 180 token, and provide 180 token to Stability Pool
    await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
    await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message = 'withdrawFromSP(), pending rewards in system. Stability Pool depositors make partial withdrawal - random amount of token'
  ...
  // it("", async () => {
  //   const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 token, provide 180 token, then withdraw all to SP after a liquidation'
  //   // 10 accts each open Trove with 10 ether, withdraw 180 token, and provide 130 token to Stability Pool
  //   await th.openTrove_allAccounts(accounts.slice(2, 12), contracts, dec(10, 'ether'), dec(130, 18))
  //   await th.provideToSP_allAccounts(accounts.slice(2, 12), stabilityPool, dec(130, 18))
  ...
  it("", async () => {
    const message = 'withdrawETHGainToTrove(), pending rewards in system. Accounts withdraw 180 token, provide a random amount, then withdraw all to SP after a liquidation'
  ...
  it("", async () => {
    ...
    await th.withdrawDebtToken_allAccounts(accounts.slice(100, 110), contracts, dec(130, 18))
  ...
  it("", async () => {
    ...
    await th.withdrawDebtToken_allAccounts(accounts.slice(100, 200), contracts, dec(130, 18))
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, { from: accounts[2] })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, { from: accounts[3] })
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, { from: accounts[4] })
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[99], ZERO_ADDRESS, { from: accounts[99] })
    await th.openTrove_allAccounts([accounts[98]], contracts, dec(1, 'ether'), 0)
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, { from: accounts[98] })
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[97], ZERO_ADDRESS, { from: accounts[97] })

    // Acct 100 withdraws 1800 token and deposits it to the SP
    await borrowerOperations.withdrawDebtToken(_100pct, dec(1750, 18), accounts[100], ZERO_ADDRESS, { from: accounts[100] })
  ...
  it("", async () => {
    ...
    await th.withdrawDebtToken_allAccounts(accounts.slice(100, 130), contracts, dec(130, 18))
