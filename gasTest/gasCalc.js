...
contract("Gas cost tests", async (accounts) => {
  ...
  it("", async () => {
    const message =
      "closeTrove(), 20 accounts, each account adds 10 ether and issues less debt token than the previous one. First 10 accounts close their trove. ";
  ...
  it("", async () => {
    const message =
      "withdrawDebtToken(), first withdrawal, 30 accounts, each account withdraws a random debt token amount";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
  ...
  it("", async () => {
    const message =
      "withdrawDebtToken(), second withdrawal, 30 accounts, each account withdraws a random debt token amount";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
  ...
  it("", async () => {
    const message =
      "repayDebtToken(), partial repayment, 30 accounts, repay random amount of token (of 100 token)";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    const message =
      "repayDebtToken(), first repayment, 30 accounts, repay in full (50 of 50 token)";
    await th.openTrove_allAccounts(_30_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawDebtToken_allAccounts(_30_Accounts, contracts, dec(100, 18));
  ...
  it("", async () => {
    ...
    const randDebtTokenAmount = th.randAmountInWei(1, 180);
    await borrowerOperations.openTrove(_100pct, randDebtTokenAmount, accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
      value: dec(10, "ether"),
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 token, redemption hits 1 Trove. No pending rewards. 3 accounts in system, partial redemption";
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, "ether"), 0);
    // 3 accounts withdraw successively less token
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, {
      from: accounts[0],
    });
    await borrowerOperations.withdrawDebtToken(_100pct, dec(90, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
    });
    await borrowerOperations.withdrawDebtToken(_100pct, dec(80, 18), accounts[2], ZERO_ADDRESS, {
      from: accounts[2],
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(500, 18), whale, ZERO_ADDRESS, {
      from: whale,
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(450, 18), whale, ZERO_ADDRESS, {
      from: whale,
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(1000, 18), whale, ZERO_ADDRESS, {
      from: whale,
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(1500, 18), whale, ZERO_ADDRESS, {
      from: whale,
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(2000, 18), whale, ZERO_ADDRESS, {
      from: whale,
    });
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts([accounts[1]], contracts, dec(10, "ether"), 0);
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
    });

    // acct 998 adds coll, withdraws token, sits at 111% ICR
    await th.openTrove_allAccounts([accounts[998]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[998], ZERO_ADDRESS, {
      from: accounts[998],
    });
  ...
  it("", async () => {
    const message =
      "redeemCollateral(), redeems 50 token, redemption hits 1 Trove. WITH pending rewards. 3 accounts in system.";
    // 3 accounts add coll
    await th.openTrove_allAccounts(accounts.slice(0, 3), contracts, dec(10, "ether"), 0);
    // 3 accounts withdraw successively less token
    await borrowerOperations.withdrawDebtToken(_100pct, dec(100, 18), accounts[0], ZERO_ADDRESS, {
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 token, all make first deposit, random debt token amount";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18));
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, deposit part of issued token: all accounts withdraw 180 token, all make second deposit, provide 50 token";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18));
  ...
  it("", async () => {
    const message =
      "provideToSP(), No pending rewards, all accounts withdraw 180 token, make second deposit, random debt token amount";
    await th.openTrove_allAccounts(_10_Accounts, contracts, dec(10, "ether"), 0);
    await th.withdrawDebtToken_allAccounts(_10_Accounts, contracts, dec(130, 18));
    await th.provideToSP_allAccounts(_10_Accounts, stabilityPool, dec(50, 18));
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[1], ZERO_ADDRESS, {
      from: accounts[1],
    });
  ...
  it("", async () => {
    ...
    // 5 active Troves withdraw their FIL gain to their trove
    const gasResults = await th.withdrawFILGainToTrove_allAccounts(
      accounts.slice(2, 22),
      contracts,
    );
    th.logGasMetrics(gasResults, message);
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[2], ZERO_ADDRESS, {
      from: accounts[2],
    });
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[3], ZERO_ADDRESS, {
      from: accounts[3],
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(600, 18), accounts[100], ZERO_ADDRESS, {
      from: accounts[100],
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[4], ZERO_ADDRESS, {
      from: accounts[4],
    });
  ...
  it("", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[99], ZERO_ADDRESS, {
      from: accounts[99],
    });
    await th.openTrove_allAccounts([accounts[98]], contracts, dec(1, "ether"), 0);
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[98], ZERO_ADDRESS, {
      from: accounts[98],
    });
    ...
    await borrowerOperations.withdrawDebtToken(_100pct, dec(130, 18), accounts[97], ZERO_ADDRESS, {
      from: accounts[97],
    });
