...
contract EchidnaProxy {
    ...
    // Borrower Operations
    function openTrovePrx(uint _ETH, uint _debtTokenAmount, address _upperHint, address _lowerHint, uint _maxFee) external payable {
        borrowerOperations.openTrove{value: _ETH}(_maxFee, _debtTokenAmount, _upperHint, _lowerHint);
    }
