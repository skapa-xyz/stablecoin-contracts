...
/*
 * The Active Pool holds the ETH collateral and debt (but not debt tokens) for all active troves.
 *
 * When a trove is liquidated, it's ETH and debt are transferred from the Active Pool, to either the
