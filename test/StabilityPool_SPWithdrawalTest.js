  ...
  async (accounts) => {
    ...
    describe("Stability Pool Withdrawal", async () => {
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and FIL Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "6666666666666666666666"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "6666666666666666666666"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "6666666666666666666666"),
          10000,
        );
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and FIL Gain after two identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "3333333333333333333333"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "3333333333333333333333"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "3333333333333333333333"),
          10000,
        );
      ...
      it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and FIL Gain after three identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "0"),
          10000,
        );
        assert.isAtMost(th.getDifference((await debtToken.balanceOf(bob)).toString(), "0"), 10000);
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "0"),
          10000,
        );
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and FIL Gain after two liquidations of increasing DebtToken", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "6000000000000000000000"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "6000000000000000000000"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "6000000000000000000000"),
          10000,
        );
      ...
      it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and FIL Gain after three liquidations of increasing DebtToken", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "4000000000000000000000"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "4000000000000000000000"),
          10000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "4000000000000000000000"),
          10000,
        );
      ...
      it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and FIL Gain after two identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "13333333333333333333333"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(
      ...
      it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and FIL Gain after three identical liquidations", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "5000000000000000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "10000000000000000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(
      ...
      */
        ...
        // ()
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "901719380174061000000"),
          100000000000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "205592018679686000000000"),
          10000000000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "5906261940140100000000"),
          10000000000,
        );
      ...
      it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 DebtToken.  A, B, C, D withdraw correct DebtToken deposit and FIL Gain", async () => {
        ...
        console.log();
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "1666666666666666666666"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "1666666666666666666666"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "1666666666666666666666"),
          100000,
        );
      ...
      it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 DebtToken.  A, B, C, D withdraw correct DebtToken deposit and FIL Gain", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(dennis)).toString(), "0"),
          100000,
        );
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "5944272445820430000000"),
          100000000000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "4458204334365320000000"),
          100000000000,
        );
        assert.isAtMost(
          th.getDifference(
      ...
      */
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "1672240802675590000000"),
          10000000000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "2090301003344480000000"),
          100000000000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "1045150501672240000000"),
          100000000000,
        );
      ...
      it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 DebtToken. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct DebtToken deposit and FIL Gain", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(alice)).toString(), "666666666666666666666"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "666666666666666666666"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "2000000000000000000000"),
          100000,
        );
      ...
      it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "5000000000000000000000"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(
      ...
      it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), "8333333333333333333333"),
          100000,
        );
        assert.isAtMost(
          th.getDifference(
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(erin)).toString(), "25000000000000000000000"),
          100000,
        );
      ...
      it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(erin)).toString(), "0"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(flyn)).toString(), "0"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(graham)).toString(), "0"),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(harriet)).toString(), "0"),
          100000,
        );
      ...
      it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and FIL Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), "100000000000000000000"),
          100000,
        );
      ...
      */
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), dec(100, 18)),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), dec(200, 18)),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(dennis)).toString(), dec(300, 18)),
          100000,
        );
      ...
      it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and FIL Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(bob)).toString(), dec(1, 17)),
          100000,
        );
      ...
      it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and FIL Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(carol)).toString(), dec(2, 17)),
          100000,
        );
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(dennis)).toString(), dec(3, 17)),
          100000,
        );
    ...
    */
      it("withdrawFromSP(): Several deposits of 10000 DebtToken span one scale factor change. Depositors withdraws correct compounded deposit and FIL Gain after one liquidation", async () => {
        ...
        assert.isAtMost(
          th.getDifference((await debtToken.balanceOf(dennis)).toString(), dec(99999, 12)),
          100000,
        );
      ...
      it("withdrawFromSP(): Depositor's FIL gain stops increasing after two scale changes", async () => {
        ...
        const alice_FILGainAt2ndScaleChange = (
          await stabilityPool.getDepositorFILGain(alice)
        ).toString();
