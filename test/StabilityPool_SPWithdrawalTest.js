  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    */
    ...
    it("withdrawFromSP(): Depositor's FIL gain stops increasing after two scale changes", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveDebtTokenAmount(dec(99999, 17)), defaulter_1, defaulter_1, { from: defaulter_1, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveDebtTokenAmount(dec(99999, 17)), defaulter_2, defaulter_2, { from: defaulter_2, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveDebtTokenAmount(dec(99999, 17)), defaulter_3, defaulter_3, { from: defaulter_3, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveDebtTokenAmount(dec(99999, 17)), defaulter_4, defaulter_4, { from: defaulter_4, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, await getOpenTroveDebtTokenAmount(dec(99999, 17)), defaulter_5, defaulter_5, { from: defaulter_5, value: dec(100, 'ether') })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and FIL price", async () => {
      ...
      const bobDebtTokenBalance = await debtToken.balanceOf(bob)
