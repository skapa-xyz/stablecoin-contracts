...
contract("TroveManager", async (accounts) => {
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    console.log(
      `Accumulated FIL difference between Default and Active Pools is: ${totalFILPoolDifference}`,
    );
    console.log(
      `Accumulated Debt difference between Active and Default Pools is: ${totalDebtPoolDifference}`,
    );
  });
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    console.log(
      `FIL difference between total pending rewards and DefaultPool: ${FILRewardDifference} `,
    );
    console.log(
      `Debt difference between total pending rewards and DefaultPool: ${DebtRewardDifference} `,
    );
  });
  ...
  */
  ...
  it("11 accounts with random FIL and proportional Debt (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    await th.openTrove_allAccounts_randomFIL_ProportionalDebt(
      1,
      2,
      accounts.slice(0, 11),
      contracts,
  ...
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 token
    await borrowerOperations.openTrove(0, 0, accounts[99], {
      from: accounts[99],
      value: dec(100, "ether"),
    });
    await borrowerOperations.withdrawDebtToken(0, dec(100, 18), accounts[99], {
      from: accounts[99],
    });
    ...
    // On loop: Account[99] adds 10 Debt to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    console.log(
      `FIL difference between total pending distribution rewards and DefaultPool: ${FILRewardDifference} `,
    );
    console.log(
      `Debt difference between total pending distribution rewards and DefaultPool: ${DebtRewardDifference} `,
    );
  });
  ...
  */
  ...
  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    await borrowerOperations.withdrawDebtToken(0, dec(100, 18), accounts[999], {
      from: accounts[999],
    });
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last Debt withdrawal from SP to underflow and fail. 
  ...
  it("11 accounts. 10 Borrowers add to SP, random Debt amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 token
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
  ...
  it("101 accounts. 100 Borrowers add to SP, random Debt amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 token
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
  ...
  */
  ...
  it("501 accounts. 500 Borrowers add to SP, random Debt amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 token
    await borrowerOperations.openTrove(0, 0, accounts[999], {
      from: accounts[999],
      value: dec(100, "ether"),
...
*/
  ...
  it("11 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
    ...
    await th.openTrove_allAccounts_randomFIL(
      100000000,
      200000000,
      accounts.slice(1, 10),
      contracts,
