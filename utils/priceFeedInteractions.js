...
//     console.log(`Testnet: Latest FIL:USD price from aggregator: ${price_aggregatorTestnet}`);
...
//     console.log(`Testnet: Latest FIL:USD price from deployed PriceFeed: ${price_PriceFeedTestnet}`)
...
//     console.log(`Mainnet: Latest FIL:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest FIL:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)
