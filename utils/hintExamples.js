...
async function main() {
  ...
  await borrowerOperations.openTrove(maxFee, debtTokenAmount, upperHint, lowerHint, {
    value: FILColl,
  });
  ...
  await borrowerOperations.adjustTrove(maxFee, 0, debtTokenRepayment, false, upperHint, lowerHint, {
    value: collIncrease,
  });
