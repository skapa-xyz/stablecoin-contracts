...
const ABDKOperations = async () => {
  ...
  // Example computaton: DebtToken -> Ether price conversion

  // price = 200.12345678, stored as uint
  // convert 6123456700909.123456789123456789 DebtToken to Ether
  // amount = 6123456700909.123456789123456789 DebtToken / 200.12345678
  ...
  /* TODO: will L_FIL, L_DebtToken overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
  ...
  /* 
    --- Using ABDK functions in the protocol ---
    
    ABDK.mulu is for: (64.64dec * uint)  -> uint.  i.e. for rewardPerUnitStaked  * stake -> reward
    
    ABDK.divu is for: (uint / uint)  -> 64.64dec.  i.e. for liquidatedFIL / totalStakes 
