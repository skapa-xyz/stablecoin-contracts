...
# return the innate component of market demand for holding ProtocolTokens.  Could be a function of:
...
def linear_decreasing_FIL_price(last_price, gradient):
    return last_price - gradient

def quadratic_FIL_price(scale, i):
    return scale*(i**2)
...
for i in range(1, 100):
    ...
    # FIL_price = oscillating_FIL_price(500, 10, i)
    # FIL_price = quadratic_FIL_price(10, i)
    # FIL_price = linear_increasing_FIL_price(last_FIL_price, 100)
    # FIL_price = linear_decreasing_FIL_price(last_FIL_price, 1)
